...
import math
from test.challeng2.src.variables import rMagenta, rRed, rGreen, rBlue, rOrange, rBlack, lotType
...
def find_pillar(contours, target, p, colour): 
    ...
    for cnt in contours: 
        ...
        if (area > 150 and colour == "red") or (area > 100 and colour == "red" and tempParking) or (area > 200 and colour == "green"):
            ...
            #goback :if the pillar is too close, stop the car and reverse to give it enough space
