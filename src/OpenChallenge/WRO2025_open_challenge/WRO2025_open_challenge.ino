...
NewPing sonar_Right_front(UltraPinRight, UltraPinRight, MAX_DISTANCE);
...
void turn_Right()
{
    ...
    if (currentMillis - previousMillis >= 2000 && turncnt <= 11)
    {
        if (error < abs(15))
        {
...
void setup()
{
    ...
    myservo.attach(servoPin, 0, 2000);
